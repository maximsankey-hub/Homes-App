...
profileRouter.put('/', async (req, res) => {
  ...
  const updated = await prisma.preferenceProfile.update({
    ...
    data: {
      ...
      petTypes: Array.isArray(petTypes) ? petTypes : profile.petTypes,
      householdComposition: householdComposition ?? profile.householdComposition,
      householdCompositionOther: householdCompositionOther ?? profile.householdCompositionOther,
